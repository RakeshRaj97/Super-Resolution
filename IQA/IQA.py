...
#-----------------------------------------
#read HR images - Ground-truth 
img_dir_hr = r"D:\Super-resolution project\EDSR\SOFTWARE\Performance-Measurement-of-AI-Assisted-Satellite-Imagery\IQA\Hr" # Enter Directory of HR images 
data_path = os.path.join(img_dir_hr,'*g')
files = glob.glob(data_path)
temp=os.listdir(img_dir_hr)
...
#read SR output images
img_dir_sr = r"D:\Super-resolution project\EDSR\SOFTWARE\Performance-Measurement-of-AI-Assisted-Satellite-Imagery\IQA\Out" # Enter Directory of SR images 
data_path1 = os.path.join(img_dir_sr,'*g')
files1 = glob.glob(data_path1)
temp1=os.listdir(img_dir_sr)
...
for f2 in files1:
    ...
    #resize image as per the HR image
